package me.hd.hookgg.hook.hooker.elgg.v126
...
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.arg
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checkboolean
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checkdouble
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checkint
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checkjstring
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checklong
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.checktable
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optboolean
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optdouble
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optint
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optjstring
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optlong
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.optstring
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.opttable
import me.hd.hookgg.hook.hooker.elgg.v126.ELGGv126VarArgs.tojstring
import me.hd.hookgg.hook.utils.GGUtil

object ELGGv126Hooker : BaseGGHooker() {
            ...
            .toClassOrNull()?.resolve()?.apply {
                firstMethod {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val text = varArgs.checkjstring(1)
                        val textStr = ELGGv126Util.decryptText(text as String)
            ...
            .toClassOrNull()?.resolve()?.apply {
                firstMethod {
                    ...
                    after {
                        ...
                        val valueStr = ELGGv126Util.decryptText(value as String)
            ...
            .toClassOrNull()?.resolve()?.apply {
                firstMethod {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val num = varArgs.tojstring(1)
                        val numStr = ELGGv126Util.decryptText(num as String)
            ...
            .toClassOrNull()?.resolve()?.apply {
                firstMethod {
                    ...
                    after {
                        ...
                        val differenceStr = ELGGv126Util.decryptText(difference as String)
            ...
            .toClassOrNull()?.resolve()?.apply {
                firstMethod {
                    ...
                    after {
                        ...
                        val timeStr = ELGGv126Util.decryptText(time as String)
